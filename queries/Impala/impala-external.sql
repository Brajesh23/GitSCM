...
-- * location path (currently /tmp/tpc-ds/sf5)

create schema if not exists tpcds_5_text;
use tpcds_5_text;
...
stored as textfile
location '/tmp/tpc-ds/sf5/call_center'
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/catalog_page'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/catalog_returns'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/catalog_sales'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/customer'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/customer_address'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/customer_demographics'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/date_dim'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/household_demographics'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/income_band'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/inventory'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/promotion'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/reason'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/ship_mode'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/store_returns'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/store_sales'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/time_dim'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/warehouse'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/web_page'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/web_returns'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/web_sales'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf5/web_site'
tblproperties ('serialization.null.format'='')
;
