---jobname:scct-ufposo-hive-stg1-po_so_dd_hu_details_ven_rfc
--------------------------------------------------------------------------
...
,'Vendor_Managed_Brand' as from_node
,po.purch_ord_nbr
...
,coalesce(dm.delv_doc_nbr,'N/A') as delv_doc_nbr
,coalesce(dm.delv_doc_itm_nbr,0) as delv_doc_itm_nbr
...
from (select * from scct_db.po_master where purch_doc_type_cd='NB' AND (del_ind<>'L' OR (del_ind='L' AND gr_qty>0)) and vend_acct_id<>'N/A' and loc_nbr<>'N/A') po 
inner join (select * from scct_db.location_master where loc_typ_cd='05' and org_num='1004') a ON po.vend_acct_id=a.loc_nbr 
inner join (select * from scct_db.location_master where loc_typ_cd IN ('04') and org_num='1119') b ON po.loc_nbr=b.loc_nbr
