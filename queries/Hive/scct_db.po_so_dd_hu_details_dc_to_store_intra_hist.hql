---jobname:scct-ufposo-hive-stg1-po_so_dd_hu_details_dc_to_store_intra
--------------------------------------------------------------------------
...
-- ----------- ------- 		----------  ------------ 	--------------------
-- 01.00.00.01 20AUG19		SCCTP4-3287	ssoma			DC to Store intra Initial Version
...
left outer join (select * from scct_db.handling_master_poso where delv_doc_itm_nbr <> '0' and itm_nbr<>'0') hm 
