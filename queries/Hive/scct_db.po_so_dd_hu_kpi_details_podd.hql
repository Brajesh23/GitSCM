---jobname:scct-ufposo-hive-stg1-po_so_dd_hu_kpi_details_podd
--------------------------------------------------------------------------
...
-- 01.00.00.03 20Aug20		SCCTP5-327  fyuan			Add ZDTD 
--------------------------------------------------------------------------
...
left join scct_db.dd_line_kpi dd
on dtl.business_process=dd.business_process and dtl.to_node=dd.to_node and dtl.po_doc_typ=dd.po_doc_typ and
dtl.dd_delv_doc_nbr=dd.delv_doc_nbr and dtl.dd_delv_doc_itm_nbr=dd.delv_doc_itm_nbr and dtl.po_itm_nbr=dd.itm_nbr
WHERE ((dtl.business_process='Turnkey_Production' and dtl.to_node='DC_Brand' AND dtl.po_doc_typ='Z1PO')
OR (dtl.business_process='Stock_Transfer_Inter_Company' and dtl.to_node='Store' AND dtl.po_doc_typ='NB')
OR (dtl.business_process='Stock_Transfer_Inter_Company' and dtl.to_node='DC_Brand' AND dtl.po_doc_typ='NB')
OR (dtl.business_process='Stock_Transfer_Inter_Company' and dtl.to_node='DC_Mast' AND dtl.po_doc_typ='NB')
OR (dtl.business_process='Component_Inflow' and dtl.to_node='DC_Mast' AND dtl.po_doc_typ='NB')
OR (dtl.business_process='Stock_Transfer_Intra_Company' and dtl.to_node='Store' AND dtl.po_doc_typ='UB')
