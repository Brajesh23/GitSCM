---jobname:scct-ufposo-hive-stg1-po_so_dd_hu_details_dc_to_store
--------------------------------------------------------------------------
...
-- ----------- ------- 		----------  ------------ 	--------------------
-- 01.00.00.01 20AUG19		SCCTP4-2922	ssoma			Initial Version
-- 01.00.00.02 06MAR20		SCCTP4-3316	ssoma			remove reducer parameter
-- 01.00.00.03 04MAY20		SCCTP4-3331	ssoma			HQL Optimization 
-- 01.00.00.04 17JAN21		SCCTP-601	Kaali M			Replaced handling_master table with handling_master_poso  
----------------------------------------------------------------------------
...
inner join (select * from scct_db.location_master where loc_typ_cd='04') b on po.loc_nbr=b.loc_nbr 
...
left outer join (select * from scct_db.handling_master_poso where itm_nbr<>'0') hm 
