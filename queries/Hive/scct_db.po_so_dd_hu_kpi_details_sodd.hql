---jobname:scct-ufposo-hive-stg1-po_so_dd_hu_kpi_details_sodd
--------------------------------------------------------------------------
...
,dtl.to_node
,dtl.po_doc_typ
from scct_db.po_so_dd_hu_details dtl left join scct_db.so_line_kpi so 
...
dtl.dd_delv_doc_nbr=dd.delv_doc_nbr and dtl.dd_delv_doc_itm_nbr=dd.delv_doc_itm_nbr and dtl.so_itm_nbr=dd.itm_nbr
WHERE dtl.business_process='DC_Outbound_SO' and dtl.to_node='Partner' AND dtl.po_doc_typ='N/A';
